...
**위의 회귀식에서 a , b값은 최적해를 여러번 구해서 제일 적합하다고 생각한 a , b를 골라서 식에 대입한 것이다.** <br>
**이 코드에서 niter은 최적해를 구하기 위한 전체 반복 루프 횟수를 나타내고 있는데 , niter의 값을 조정하며 최적해가 어떻게 변해가는지** <br>
**한번 보도록 하겠다.**
...
**값의 차이가 굉장히 많이 나는걸 알 수 있다. 회귀식 추정을 물론이고 경향성 조차 추측하기 힘들다.**
