...
### 2. 데이터 중 하나를 임의로 선택해 , 다른 집단으로 옮긴 후 , 평가값(2)를 구한다. [이웃해를 구한다] 
...
### 3. 평가값(1)과 평가값(2)를 비교했을때 , 평가값(2)가 더 작으면 , 이웃해를 새로운 해로 받아들인다.** <br><br>

**동일한 온도 T에서 위의 과정을 t회 반복 한다. 온도 T는 △T만큼 변화시켜주고 <br>
